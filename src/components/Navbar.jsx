  ...
  return (
    <div className='flex items-center justify-between px-4 py-2 dark:bg-gray-700 bg-gray-200'>
      ...
      <div className='flex items-center justify-evenly lg:w-1/4 w-1/2 dark:text-white'>
        ...
        <span className='dark:bg-gray-900 bg-gray-300 lg:w-[100px] w-full mx-1 flex items-center justify-evenly rounded-md py-2'><BsFillCartCheckFill size='25px'/>0</span>
      </div>
    </div>
  )
}
